...
export const sampleIdeas: Idea[] = [
  {
    ...
    description:
      "A guided Friday flow that turns loose notes, links, and reflections into a cleaner plan for the next week.",
    category: "Product",
    status: "Reviewing",
    priority: "High",
  ...
  },
  {
    ...
    description:
      "Block a short weekend sprint to archive stale notes, tag useful references, and create a lightweight learning index.",
    category: "Learning",
    status: "Raw Idea",
    priority: "Medium",
  ...
  },
  {
    ...
    description:
      "Create one dashboard for subscriptions, savings targets, upcoming bills, and quick monthly review prompts.",
    category: "Finance",
    status: "Approved",
    priority: "Urgent",
  ...
  },
  {
    ...
    description:
      "Improve lighting, cable management, and recording backdrop so creative work feels easier to start.",
    category: "Home",
    status: "Parked",
    priority: "Low",
  ...
  },
  {
    ...
    description:
      "Build reusable outlines for essays, product updates, launch notes, and reflective posts.",
    category: "Writing",
    status: "Raw Idea",
    priority: "Medium",
...
export const sampleProjects: Project[] = [
  {
    ...
    description:
      "Turn scattered creative workflows into reusable templates for idea capture, production, and review.",
    category: "Creative",
    status: "Planning",
    priority: "High",
    ...
    tasks: [
      {
        id: "task-1-1",
        title: "Define core project templates",
        completed: true,
        dueDate: "2026-06-14",
        stickyNotes: [],
      ...
      {
        id: "task-1-2",
        title: "Map publishing and review rituals",
        completed: false,
        dueDate: "2026-06-28",
        stickyNotes: [],
        contactIds: [],
      ...
      {
        id: "task-1-3",
        title: "Create first dashboard prototype",
        completed: false,
        dueDate: "2026-07-10",
        stickyNotes: [],
        contactIds: [],
  ...
  },
  {
    ...
    title: "Quarterly finances command center",
    description:
      "Create one calm place to monitor subscriptions, savings targets, bills, and monthly finance reviews.",
    category: "Finance",
    status: "Active",
    priority: "Urgent",
    ...
    tasks: [
      {
        id: "task-2-1",
        title: "List recurring subscriptions",
        completed: true,
        dueDate: "2026-06-08",
        stickyNotes: [],
      ...
      {
        id: "task-2-2",
        title: "Design command center layout",
        completed: true,
        dueDate: "2026-06-12",
        stickyNotes: [],
        contactIds: ["contact-2"],
      ...
      {
        id: "task-2-3",
        title: "Add monthly review prompts",
        completed: false,
        dueDate: "2026-06-20",
        stickyNotes: [],
        contactIds: [],
      ...
      {
        id: "task-2-4",
        title: "Schedule first review block",
        completed: false,
        dueDate: "2026-06-27",
        stickyNotes: [],
        contactIds: [],
  ...
  },
  {
    ...
    description:
      "Archive stale notes, tag useful references, and create a lightweight learning index for the next quarter.",
    category: "Learning",
    status: "Scheduled",
    priority: "Medium",
    ...
    tasks: [
      {
        id: "task-3-1",
        title: "Sort captured references",
        completed: false,
        dueDate: "2026-07-12",
        stickyNotes: [],
        contactIds: [],
      ...
      {
        id: "task-3-2",
        title: "Create learning index categories",
        completed: false,
        dueDate: "2026-07-19",
        stickyNotes: [],
        contactIds: [],
...
export const sampleContacts: Contact[] = [
  {
    ...
    phone: "(555) 014-2201",
    notes: "Helpful for reviewing template clarity and publishing rituals.",
    relatedTaskIds: ["task-1-1"],
  ...
  },
  {
    ...
    phone: "(555) 019-8842",
    notes: "Review command center assumptions before automating calculations.",
    relatedTaskIds: ["task-2-1", "task-2-2"],
...
export const sampleCalendarItems: CalendarItem[] = [
  {
    ...
    description:
      "Pressure-test the workflow, capture risks, and decide whether this becomes a project template.",
    date: "2026-06-11",
    time: "09:00",
    type: "Idea Review",
    status: "Scheduled",
  ...
  },
  {
    ...
    description:
      "Deep work block for the project dashboard structure and first-review prompts.",
    date: "2026-06-12",
    time: "14:30",
    type: "Project Task",
    status: "In Progress",
  ...
  },
  {
    ...
    description:
      "Map publishing and review rituals before building the first reusable dashboard.",
    date: "2026-06-15",
    time: "10:00",
    type: "Deep Work",
    status: "Scheduled",
  ...
  },
  {
    ...
    description:
      "Clear stale tasks, file reference notes, and reset the coming week action list.",
    date: "2026-06-09",
    time: "16:00",
    type: "Admin",
    status: "Missed",
  ...
  },
  {
    ...
    description:
      "Finalize review questions for subscriptions, savings, and upcoming bills.",
    date: "2026-06-20",
    type: "Deadline",
    status: "Scheduled",
    relatedProjectId: "project-2",
